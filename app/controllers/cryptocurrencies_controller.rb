class CryptocurrenciesController < ApplicationController
  ...
  # this authenticate user before doing anything from this controller
  before_action :authenticate_user!
  # show the correct pages to the correct users
  ...
  private
    ...
    def correct_user
      ...
      redirect_to cryptocurrencies_path, notice: 'You are not autherized to access that page' if @correct.nil?
    end
end
